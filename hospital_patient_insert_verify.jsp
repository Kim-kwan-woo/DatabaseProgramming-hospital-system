...
<html>
	...
	<body>
        ...
        request.setCharacterEncoding("utf-8");
            ...
            String p_doctorid = request.getParameter("p_doctorid");
            String p_hospitalization = request.getParameter("p_hospitalization");
            String p_nurseid = request.getParameter("p_nurseid");
            String t_detail = request.getParameter("t_detail");
            String result = null;
			
            result = patientMgr.insertPatient(p_id, p_name, p_sex, p_phone, p_address, p_email, p_doctorid, p_hospitalization, p_nurseid, t_detail);
